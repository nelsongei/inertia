<template>
    ...
    <div class="flex flex-wrap justify-between">
        <div><h3 class="text-2xl font-bold text-left text-black">Items</h3>
            <nav>
                <ol class="flex flex-wrap py-4 text-gray-900 rounded list-reset">
                    <li class="pr-2 text-sm">
                        ...
                        <span
                            class="px-1">/</span></li>
                    <li class="pr-2 text-sm">
                        <NavLink aria-current="page" href="/items"
        ...
        <div class="flex items-center" v-if="items.length>0">
    ...
    <div v-if="items.length<1">
        <div class="flex flex-col items-center justify-center mt-16" style="">
            <div class="flex flex-col items-center justify-center">
                <svg width="110" height="110" viewBox="0 0 110 110" fill="#3b82f6" xmlns="http://www.w3.org/2000/svg"
                     class="mt-5 mb-4">
            ...
            <div class="mt-2"><label class="font-medium">No items yet!</label></div>
            <div class="mt-2"><label class="text-gray-500">This section will contain the list of items.</label></div>
            <div class="mt-6">
                <NavLink
                    href="items/create"
